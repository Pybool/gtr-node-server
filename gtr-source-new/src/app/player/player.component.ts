...
import { AudioService } from '../_service/audio.service';
import { CloudService } from '../_service/cloud.service';
...
export class PlayerComponent implements OnInit {
  ...
  playAudio(){
    this.audioService.stop();
    let audioContext = WindowRef.prototype.nativeWindow.audioContext;  
    if(audioContext){
      audioContext.pause()
