...
$xml->asXML('/home/ubuntu/gtr-source/dist/gtrweb/browser/sitemap/'.$name);
}
...
$xml->asXML('/home/ubuntu/gtr-source/dist/gtrweb/browser/sitemap.xml');
...
$res=json_decode(file_get_contents("https://api.ghanatalksradio.com/bats.php"),true);
if($res['status']){
